"""park_ave_19799 URL Configuration
...
admin.site.site_header = "PARK AVE"
admin.site.site_title = "PARK AVE Admin Portal"
admin.site.index_title = "PARK AVE Admin"

# swagger
api_info = openapi.Info(
    title="PARK AVE API",
    default_version="v1",
    description="API documentation for PARK AVE App",
)
